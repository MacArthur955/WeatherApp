<h3>To see how the website is working you can download it's docker image from https://hub.docker.com/repository/docker/macarthur955/weatherapp to docker, using docker-compose file.</h3>
